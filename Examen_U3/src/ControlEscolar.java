...
public class ControlEscolar extends JFrame {
	...
	private JPanel contentPane, panelVentana1, panelMenu, panelMenuVertical, panelSur, panel;
	private JTextField nombres;
	private JPasswordField password;
	private JLabel logo, castillo; 
	...
	private JButton btn_1, btn_2, btn_3,  btn_4, btn_5, btn_6, btn_7, btnRegistrarNuevo;
	...
	public void inicioSesion() // Con menu, Inicio - Recuperar contraseña - Como acceder
	{
		contentPane.setLayout(new BorderLayout(0, 0));
		panelMenu = new JPanel();
		panelMenu.setBackground(new Color(199, 146, 66));
		...
		item2.addActionListener(new ActionListener()		{
        	public void actionPerformed(ActionEvent e) {
		        ...
		        contentPane.revalidate();
		        contentPane.repaint();
		        contentPane.add(panelMenu, BorderLayout.NORTH); //Agregar a ventanas
        	}
        });
		menu.add(item2);
	...
	public void menuPrincipal()
	{
		...
		btn_7 = new JButton("Elimnar docente");
		...
		labelGris.setBackground(new Color(217, 217, 217));
		labelGris.setOpaque(true);
	...
	public void elementosV2()	{
		...
		JLabel labelEscuela = new JLabel("Colegio Hogwarts de Magia y Hechiceria");
		labelEscuela.setBounds(108, 42, 753, 80);
		labelEscuela.setForeground(Color.white);
		labelEscuela.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 37));
		panel.add(labelEscuela);
